...
set(SHADER_SYMBOLS kWorldVertexSource kWorldFragmentSource)
...
foreach(INDEX RANGE 1)
  ...
  list(GET SHADER_SYMBOLS ${INDEX} SYMBOL)
  ...
  foreach(DIALECT GLES GL)
    ...
    set(DIALECT_FILE "${SHADER_DIR}/world_${DIALECT}.${STAGE}.glsl")
    ...
    if (NOT VALIDATE_RESULT EQUAL 0)
      message(FATAL_ERROR "compile_shaders: world_${DIALECT}.${STAGE}.glsl is not valid ${DIALECT_NAME}:\n${VALIDATE_OUTPUT}")
    endif()

    message(STATUS "compile_shaders: world_${DIALECT}.${STAGE}.glsl validated as ${DIALECT_NAME}")
  endforeach()
...
file(WRITE "${SHADER_DIR}/world_glsl.h" "${GENERATED_HEADER}")
